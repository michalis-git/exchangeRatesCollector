...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HttpRequest_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 97, 5)
    ...
    "requestReceived\0QNetworkReply*\0reply\0"
};
...
void HttpRequest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpRequest::requestIsFinished)) {
                *result = 0;
            }
        }
        {
            typedef void (HttpRequest::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpRequest::rateRequestIsFinished)) {
                *result = 1;
            }
        }
    }
