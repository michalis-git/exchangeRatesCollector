...
QT_MOC_LITERAL(1, 12, 17), // "requestIsFinished"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 21), // "rateRequestIsFinished"
QT_MOC_LITERAL(4, 53, 12), // "currencyName"
QT_MOC_LITERAL(5, 66, 15), // "requestReceived"
QT_MOC_LITERAL(6, 82, 14), // "QNetworkReply*"
QT_MOC_LITERAL(7, 97, 5) // "reply"

    },
    "HttpRequest\0requestIsFinished\0\0"
    "rateRequestIsFinished\0currencyName\0"
...
void HttpRequest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestIsFinished(); break;
        case 1: _t->rateRequestIsFinished((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HttpRequest::requestIsFinished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HttpRequest::rateRequestIsFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HttpRequest::requestIsFinished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void HttpRequest::rateRequestIsFinished(QString _t1)
{
